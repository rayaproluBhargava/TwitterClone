...
/* This file checks if the user posted a tweet which is less than 140 characters and displays it on the page and also checks for errors */
...
if(isset($_POST['tweet'])){
	...
	if(!empty($status)){
		if(strlen($status) > 140){
			$error = "The text of the tweet is too long";
		}
		else{
			$getFromUser->create('tweets', array('status' => $status, 'tweetBy' => $user_id, 'postedOn' => date('Y-m-d H:i:s')));
		}
	}
	else {
		$error = "Type your tweet";
	}
}
								...
								<div class="info-inner">
									...
									<div class="info-in-body">
										...
										<div class="info-body-name">
											<div class="in-b-name">
												<div><a href="<?php echo $user->user_name;?>"><?php echo $user->screenName;?></a></div>
